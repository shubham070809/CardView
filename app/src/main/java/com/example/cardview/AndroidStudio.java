...
public class AndroidStudio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        androidRV=(RecyclerView)findViewById(R.id.androidRV);
        androidRV.setLayoutManager(new LinearLayoutManager(this));
